 ...
 *
 * La interfaz está en español y las categorías de BGG no, así que se traducen las que
 * salen en casi todas las fichas; el resto se queda en su idioma, que es mejor que
 * quedarse sin lema. El icono sale de la primera categoría que tenga uno: es el emoji
 * que se pinta cuando un juego no tiene carátula.
 */
